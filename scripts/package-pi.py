...
files={}
for name in ['server.py','photos.py','highlights.py','team_sports.py','quotes.json','release.py','kiosk.sh','install.sh','README.md','HIGHLIGHTS.md','VALIDATION.md','THIRD-PARTY-NOTICES']:
